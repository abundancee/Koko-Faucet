...
contract KokoToken is ERC20, Ownable {
    ...
    constructor() ERC20("KOKO", "KO") Ownable(msg.sender) {
    ...
    function requestToken() external {
        require(
            ...
            "KokoToken: Must wait 24 hours between claims"
        );
        
        require(
            totalSupply() + CLAIM_AMOUNT <= MAX_SUPPLY,
            "KokoToken: Exceeds maximum supply"
        );
    ...
    function mint(address to, uint256 amount) external onlyOwner {
        require(
            ...
            "KokoToken: Minting would exceed maximum supply"
        );
        
        require(to != address(0), "KokoToken: Invalid recipient address");
